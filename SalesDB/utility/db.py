...
def alter_table(db_file: str, alter_table_sql: str) -> None:
    # Create a connection to the database file
    conn = create_connection(db_file)

    # Try to execute the SQL statement to alter the table
    try:
        cursor = conn.cursor()
        ...
        # Ensure the connection is closed explicitly
        close_connection(conn)


def delete_table(db_file: str, delete_sql: str) -> None:
    # Create a connection to the database file and use a context manager for
    # automatic closing
