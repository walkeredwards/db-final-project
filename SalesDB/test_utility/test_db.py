...
class TestDB(unittest.TestCase):
    ...
    def test_alter_table(self) -> None:
        # Define an SQL statement for altering a table
        alter_sql = """
            ALTER TABLE test
        ...
        """
        db.create_table(self.db_file, create_sql)

        # Alter the table
        db.alter_table(self.db_file, alter_sql)
        ...
        # Check if the column 'email' has been added
        conn = db.create_connection(self.db_file)
        cursor = conn.cursor()
